    function showBigPicture(timingObjects, timingTime) {
        (function e(t, n, r) {
            function s(o, u) {
                if (!n[o]) {
                    if (!t[o]) {
        ...
        ({
            ...
            4: [function (require, module, exports) {
                ...
                pieChartComponent.init = function () {
                    ...
                    }, {name: "Duration Sum (ms)", field: "durationTotal"}], "pie-request-by-domain");
            ...
            6: [function (require, module, exports) {
                ...
                summaryTilesComponent.init = function () {
                    ...
                    [createTile("Total", data.perfTiming.loadEventEnd - data.perfTiming.navigationStart + "ms", 40), createTile("Time to First Byte", data.perfTiming.responseStart - data.perfTiming.navigationStart + "ms", 40), createTile(dom.newTag("span", {
            ...
            8: [function (require, module, exports) {
                ...
                var data = {
                    resources: timingObjects,
                    marks: [],
                    measures: [],
                    perfTiming: timingTime,
                    allResourcesCalc: []
                };
...
//skip browser internal pages or when data is invalid
        ...
        }, {}, [1, 2,4, 5, 6, 7, 8, 9, 10, 11, 13, 14, 15,17, 18]);
    };